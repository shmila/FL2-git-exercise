...
#
# x_str, y_str, out_str = sess.run([x,y,out])
#
# print('selected x and y: %s %s=>%s'%(x_str,y_str,out_str))
...
# mat = tf.random_uniform((10,10))
# det = tf.matrix_determinant(mat)
# print(sess.run([mat,det]))
...
x = tf.random_uniform((1,300))
y = tf.random_uniform((1,300))

f1 = lambda: tf.reduce_sum(tf.square(x-y))
